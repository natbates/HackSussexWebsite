...
const Feedback = () => {
  ...
  const WEB_APP_URL =
    "https://script.google.com/macros/s/AKfycbxjDCVtVu1Lyv1U6rwIuimH2ss84w9R5dF7ITg-oowyAwXyeivnb9fqtR9gCHQW8FmPfw/exec";
    ...
    return (
      <div className={styles.container}>
        <div className={styles.feedbackForm}>
          <h1>{messages.alreadySubmittedTitle}</h1>
          <p className={styles.alreadySubmitted}>
            {messages.alreadySubmittedText}
          </p>
        </div>
      </div>
    );
